...
\resumePOR{Teaching Assistant } % Position
    {at NYCU CS Information Technology Center} %Club,Event
    {June 2024 - Present} %Tenure Period
    \\\vspace{2mm}
    \ \ \textit{Collaborated with industry partners to formulate contest problems and developed the registration website.}
    \vspace{-2mm}
\resumePOR{Developer } % Position
    {in NYCU CS Student Association Development Team} %Club,Event
    {June 2024 - Present} %Tenure Period
    \\\vspace{2mm}
    \ \ \textit{Collaborated with industry partners to formulate contest problems and developed the registration website.}
    \vspace{-2mm}
\resumePOR{Developer } % Position
    {in Meichu Hackathon Development Team} %Club,Event
    {March 2024 - October 2024} %Tenure Period
    \\\vspace{2mm}
    \ \ \textit{Collaborated with industry partners to formulate contest problems and developed the registration website.}
\resumeSubHeadingListEnd
\vspace{-7mm}
