...
\resumePOR{Teaching Assistant, } % Position
    {NYCU CS Information Technology Center} %Club,Event
    {June 2024 - Present} %Tenure Period
    -work description in 1 line
\resumePOR{Development Team, } % Position
    {NYCU CS Student Association} %Club,Event
    {June 2024 - Present} %Tenure Period
    -work description in 1 line
\resumePOR{Development Team, } % Position
    {Meichu Hackathon} %Club,Event
    {March 2024 - Present} %Tenure Period
    -work description in 1 line
